...
-->
<xsl:template match="/">
<xsl:value-of select="php:function('header','content-type:application/vnd.ms-excel')" />
<xsl:value-of select="php:function('Core_Http_Header::ContentDisposition',concat(//rows/params/title,'.xml'))" />
	...
	<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
	 ...
	 <Worksheet ss:Name="datos.xml">
	  ...
	  <xsl:attribute name="ss:ExpandedColumnCount" >
	   ...
	   <xsl:value-of select="count(//columnas/*)-1" />
	   </xsl:attribute>
	   <Data ss:Type="String">
