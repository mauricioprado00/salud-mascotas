		...
		<xsl:for-each select="./actividad">
			<row>
				...
				<a href="#audiencia/listar" onclick="getGrid(this).setSelection(']]><xsl:value-of select="id" /><![CDATA[')"><div class="lstse" ></div></a>
					...
					<a href="#audiencia/delete/]]><xsl:value-of select="id" /><![CDATA[" onclick="getGrid(this).setSelection(']]><xsl:value-of select="id" /><![CDATA['); return confirm(']]><![CDATA[')"><div class="lstde"></div></a>
