(function(){
  var myLoc = null;
	...
	window.MapaNavTeq = {
		url_buscar_ubicacion: null,
		id_lat: null,
		id_lgn: null,
		txt_my_house: '',
		custom_onload: null,
		initialize: function( url_buscar_ubicacion, id_lat, id_lgn, id_mapa, txt_my_house, custom_onload ) {
			this.url_buscar_ubicacion = url_buscar_ubicacion;
			this.id_lat = id_lat;
			this.id_lgn = id_lgn;
...
//			"Longitude: "+ e.Coordinate.Longitude +"<br /> Latitude: " +e.Coordinate.Latitude;
		...
		geocode: function ( searchText ){
			...
			this.conn = this.geocoder.geocode( { SearchText: Map24.trim( searchText ), MaxNoOfAlternatives: 10, CallbackFunction: this.geocoderCallback.bind(this) } );
			return this;
		},
...
//				result += "<hr/>";
				result += '<a href="javascript:void(0);"' + onclick_attr + '>' + link_text + '</a><br />';
