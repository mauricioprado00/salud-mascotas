(function(){
	viewVacunaciones = function(){
		
	}
	viewVacunaciones.prototype = {
		jqcontainer: null,
		...
		init_add_points: function(){
			var that = this;
			//window.console.log(this.jqcontainer, this.jqcontainer.find('>li'));
			this.jqcontainer.find('>li').each(function(idx,item){
