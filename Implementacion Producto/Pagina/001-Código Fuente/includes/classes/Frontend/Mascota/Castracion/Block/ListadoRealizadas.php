<?php
class Frontend_Mascota_Castracion_Block_ListadoRealizadas extends Frontend_Mascota_Castracion_Block_ListadoPendientes{
	public function getSearchObject(){
		
		$search_object = parent::getSearchObject();;
		$search_object->setEstadoCastracion('realizada');
		//var_dump($search_object->searchGetSql());die(__FILE__.__LINE__);
