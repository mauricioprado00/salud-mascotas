<?php
class Frontend_Mascota_Castracion_Block_ListadoAsignadas extends Frontend_Mascota_Castracion_Block_ListadoPendientes{
	public function getSearchObject(){
		
		$search_object = parent::getSearchObject();;
		$search_object->setEstadoCastracion('asignada');
