...
*/
class Frontend_Model_AdopcionOferta extends Saludmascotas_Model_AdopcionOferta{
...
//		$this->setHoraExtravio($hora_extravio, array());
	...
	public function insertFromUserInput($data=null,$use_null_values=false, $get_sql=false){
		...
		$this->setFechaExpiracion(time()+60*60*24*Saludmascotas_Model_Config::findConfigValue('sm/dias_expiracion_adopcion_oferta', 7*4/*4 semanas*/));
	...
	public function getUrlEditar($preserve_mascota_edicion=0, $paso=1){
		...
		return Frontend_Mascota_AdopcionOferta_Helper::getUrlEditar($mascota->getId(), $preserve_mascota_edicion, $paso);
	}
}
