 ...
 * @Date		2006/05/31
 * @LastMOd		2006/08/01 [requires Core_Packer_SourceMap.class.php to parse source faster and better (dojo.js.uncompressed.js file (211Kb) successfull cleaned or packed)]
 * @Version		0.8
 * @Dependencies	Server: Core_Packer_BaseConvert.class.php
 *			Server: Core_Packer_SourceMap.class.php
 ...
 */
if(!class_exists('Core_Packer_SourceMap'))
	require 'Core_Packer_SourceMap.class.php';
class Core_Packer_JavaScriptCompressor {
	...
	/**
	 * public constructor
         * 	creates a new Core_Packer_BaseConvert class variable (base 36)
	 */
	function __construct() {
		$this->__SourceMap = new Core_Packer_SourceMap();
		$this->__BC = new Core_Packer_BaseConvert('0123456789abcdefghijklmnopqrstuvwxyz');
