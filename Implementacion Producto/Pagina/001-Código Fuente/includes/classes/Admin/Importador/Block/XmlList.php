<?
class Admin_Importador_Block_XmlList extends Jqgrid_Block_XmlList{
	protected function loadData($page, $rows, $sidx, $sord, $comparator){
		...
		*/
		//$admin_user = new Admin_Importador_Model_Importacion();
		$admin_user = new Admin_Importador_Model_View_Importacion2();
		if($comparator!=null){
