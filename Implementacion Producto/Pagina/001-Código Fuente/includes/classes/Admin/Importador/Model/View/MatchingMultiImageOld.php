<?
class Admin_Importador_Model_View_MatchingMultiImageOld extends Granguia_Db_Model_View_Abstract{
	public function Admin_Importador_Model_View_MatchingMultiImageOld($id_importacion_productos, $arr_ids_importacion_imagenes){
		parent::__construct();
