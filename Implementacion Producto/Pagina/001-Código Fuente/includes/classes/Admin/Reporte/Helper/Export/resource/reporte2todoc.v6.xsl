	...
	<w:document xmlns:ve="http://schemas.openxmlformats.org/markup-compatibility/2006" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:m="http://schemas.openxmlformats.org/officeDocument/2006/math" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:wp="http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing" xmlns:w10="urn:schemas-microsoft-com:office:word" xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main" xmlns:wne="http://schemas.microsoft.com/office/word/2006/wordml">
	  <w:body>
		...
		<xsl:for-each select="./inta_actividad_byagencia">
			...
			<xsl:if test="count(./actividad_agencia/agencia/documento_caracterizacion/entity)=0">
					<w:p w:rsidR="00E6534C" w:rsidRDefault="00E6534C" w:rsidP="00E6534C">
					  <w:pPr>
						<w:rPr>
						  <w:rStyle w:val="apple-style-span"/>
					  ...
					  <w:r>
						...
						<w:t>No posee documento de caracterizacion en la base de datos(debe ser formato docx)</w:t>
					  </w:r>
					</w:p>
			</xsl:if>
			<xsl:if test="count(./actividad_agencia/agencia/documento_caracterizacion/entity)!=0">
				<w:p w:rsidR="00E6534C" w:rsidRDefault="00E6534C" w:rsidP="00E6534C">
				  <w:r>
					<w:object w:dxaOrig="12663" w:dyaOrig="9112">
					  ...
					  <v:shape type="#_x0000_t75" style="width:200pt;height:48pt" o:ole="">
						<xsl:attribute name="id">
							<xsl:value-of select="concat('_x0000_i1025',php:function('Jqgrid_Block_XmlServer::secuencia','IDDOCAGSHA'))" />
						</xsl:attribute>
						<v:imagedata r:id="rId5" o:title="Doble click para abrir"/>
					  </v:shape>
					  <o:OLEObject Type="Embed" ProgID="Word.Document.12" ShapeID="_x0000_i1025" DrawAspect="Content" ObjectID="_1353074260">
						<xsl:attribute name="r:id">
							<xsl:value-of select="./actividad_agencia/agencia/documento_caracterizacion/entity/id" />
						</xsl:attribute>
						<xsl:attribute name="ShapeID">
							<xsl:value-of select="concat('_x0000_i1025',php:function('Jqgrid_Block_XmlServer::secuencia','IDDOCAGSHA',0))" />
						</xsl:attribute>
					  </o:OLEObject>
					</w:object>
				  </w:r>
