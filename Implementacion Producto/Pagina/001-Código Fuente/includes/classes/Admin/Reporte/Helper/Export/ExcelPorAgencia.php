<?php
class Admin_Reporte_Helper_Export_ExcelPorAgencia extends Core_Singleton{
	const USE_SHELL_EXEC = true;
	const DOWNLOAD_FILE_NAME = 'Actividades_x_Agencia.xml';
	const TITULO = 'Listado de Actividad por Agencia';
