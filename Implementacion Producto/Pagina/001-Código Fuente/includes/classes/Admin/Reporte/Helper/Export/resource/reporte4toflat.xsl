	...
	<entity>
		...
		<xsl:for-each select="./resultado_actividad">
			<actividad>
				...
				<nombre_proyecto>
					<xsl:value-of select="concat(./nombre_proyecto, '(', ./actividad_instancia/actividad/nombres_proyectos, ')')" />
				</nombre_proyecto>
				<presupuesto_proyecto>$<xsl:value-of select="./actividad_instancia/actividad/presupuesto_proyecto" /></presupuesto_proyecto>
