<?php
class Admin_Reporte_Helper_Export_ExcelPorProyectoPorAgencia extends Core_Singleton{
	const USE_SHELL_EXEC = true;
	const DOWNLOAD_FILE_NAME = 'Actividades_x_Proyecto_x_Agencia.xml';
	const TITULO = 'Listado de Actividad por Agencia por Proyecto';
...
//			$reporte = new Inta_Model_Reporte_Actividad();
			$reporte = new Inta_Model_Reporte_View_ActividadByProyecto();
...
//		$xs->appendStyle(dirname(__FILE__).'/resource/reporte3toflat.xsl');
		$xs->appendStyle(dirname(__FILE__).'/resource/reporte4toflat.xsl');
