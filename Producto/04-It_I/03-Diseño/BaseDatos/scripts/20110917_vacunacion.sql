...
-- -----------------------------------------------------
-- Table `app_saludmascotas`.`sm_vacunacion`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `app_saludmascotas`.`sm_vacunacion` ;

CREATE  TABLE IF NOT EXISTS `app_saludmascotas`.`sm_vacunacion` (
  ...
  CONSTRAINT `fk_vacunacion_id_spa`
    FOREIGN KEY (`id_spa` )
    REFERENCES `app_saludmascotas`.`sm_usuario` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_vacunacion_id_domicilio`
